...
import { CloseFormButton, FormCard, FormGrid, SelectField, SlideFormPanel, TextField, TextareaField } from "@/components/form-kit";
...
export default function PaymentsPage() {
  ...
  return (
    <div className="space-y-6">
      <AccountingHeader titleKey="payments" subtitleKey="paymentsSubtitle" action="Record payment" onActionClick={() => setIsFormOpen(true)} />
      ...
      <SlideFormPanel open={isFormOpen}>
        <FormCard title="Record payment" description="Use for customer receipts, supplier payments, advances, and settlement notes." action={<CloseFormButton onClick={() => setIsFormOpen(false)} />} asForm>
          <FormGrid columns={3}>
